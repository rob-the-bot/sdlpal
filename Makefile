...
HOST = $${HOME}/aarch64-buildroot-linux-gnu_sdk-buildroot/bin/aarch64-buildroot-linux-gnu-
TEST_CCFLAGS =
...
SOURCES = .. ../adplug ../liboggvorbis/src ../libopusfile/src ../libopusfile/celt ../libopusfile/silk ../libopusfile/silk/float ../libmad ../timidity
...
SDL_CONFIG = $${HOME}/aarch64-buildroot-linux-gnu_sdk-buildroot/aarch64-buildroot-linux-gnu/sysroot/usr/bin/sdl2-config
...
ifeq ($(UNAME_S),Darwin)
	...
	LDFLAGS += -L$${HOME}/aarch64-buildroot-linux-gnu_sdk-buildroot/aarch64-buildroot-linux-gnu/sysroot/usr/lib64/gl4es -lGL -pthread
	OBJFILES = $(TOBJFILES)
endif
